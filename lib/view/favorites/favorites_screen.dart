  ...
  getProfile() async {
    ...
    if (reponse.statusCode == 200) {
      ...
      if (jsonData["status"]) {
        ...
        favoritesList = data["favorites_business"];
      } else {
        showMessage(jsonData["message"], Colors.red, Icons.error);
      }
      setState(() {
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      rateBusiness(business["busii_id"], businessRating);
                                    },
                                    child: Text(
                                      "Rate",
    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : favoritesList.isEmpty
              ? Center(
                  child: Text(
                    "No favourites business available",
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: () => showModalSheet(context, favoritesList[index]),
                        child: CategoryWidget(
                          width: width,
                          business: favoritesList[index],
                        ),
                      ),
                    );
                  }),
...
class CategoryWidget extends StatefulWidget {
  const CategoryWidget({Key? key, required this.width, required this.business}) : super(key: key);
